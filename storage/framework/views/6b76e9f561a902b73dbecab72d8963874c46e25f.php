...
<form action="<?php echo e(url('/artis')); ?>">
	...
	<table  class="table table-hover ">
		...
		<tr class="table-primary" class="cen">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\uas final\resources\views/track/index.blade.php ENDPATH**/ ?>